...
const mapStateToProps = function(state) {
  return {
    consumerUser: state.profile.consumerUser,
    households: state.profile.households,
    householdSSID: HouseholdRegistrationSelector.householdSSID(state.householdRegistration),
    householdBSSID: HouseholdRegistrationSelector.householdBSSID(state.householdRegistration)
